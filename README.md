...
###2 Les règles de déclaration des variables en JavaScript
...
Pour initialiser une variable, on utilise l’opérateur = qui est dans ce cas non pas un opérateur d’égalité mais un opérateur d’assignation ou d’affectation.
...
###4 Modifier la valeur stockée dans une variable
...
![capture4](https://github.com/AnkaDemetria/JavaScriptInitiation/blob/main/img/capture4.png)
...
###5 La différence entre les mots clefs let et var
...
###6 La remontée ou « hoisting » des variables
...
![capture5](https://github.com/AnkaDemetria/JavaScriptInitiation/blob/main/img/capture5.png)

###7 La redéclaration de variables
...
![capture6](https://github.com/AnkaDemetria/JavaScriptInitiation/blob/main/img/capture6.png)

##<u>Le choix de la déclaration des variables : plutôt avec let ou plutôt avec var</u>
...
##<u>Quelle utilité pour les variables en pratique ?</u>
...
*******************************************
#<center>LES TYPES DE VALEURS EN JAVASCRIPT</center>
##<u>LES OPERATEURS MATHEMATIQUES</u>
Il en existe de nombreux types d'opérateurs mais nous verrons les 3 types dont nous aurons besoin: opérateurs arithmétiques, opérateurs d 'affectation et opérateurs de comparaison. Par exemple, l’opérateur * va nous permettre de multiplier les valeurs de deux variables, tandis que l’opérateur = va nous permettre d’affecter une valeur à une variable.
...
##<u>LES OPERATEURS DE COMPARAISON</u>
| Opérateur | Définition|
| :-------| :----:| -----:|
| ==| Permet de tester l'égalité sur les valeurs |
| === | Permet de tester  l'égalité en termes de valeurs et de types |
|!=| Permet de tester la différence en valeurs|
| <> | Permet  aussi de tester la différence en valeurs |
...
Notez que notre « égal » mathématique (l’égalité en termes de valeurs) se traduit en JavaScript par le double signe égal ==.
...
##<u>LES OPERATEURS D'AFFECTATION</u>
...
Ce qui est au dessus de la ligne d'entête sera en gras.
